...
// Основные настройки:
$recipients = ['volodymyr.kalakura@gmail.com']; // Получатели писем
...
$after_table = '<i style="color:#bbb;font-size:12px">Сообщение отправлено с сайта Актерский курс
</i>'; // HTML-содержимое после таблицы
...
$smtp_username = 'wouch1234@gmail.com'; // Почтовый ящик, с которого будут отправляться письма
$smtp_password = 'Wouch1234ww'; // Пароль почтового ящика, с которого будут отправляться письма
